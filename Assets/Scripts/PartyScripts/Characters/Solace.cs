...
public class Solace : Character
{
    public void RemoveWeaponRight()
    {
        ...
        weaponRight = null;
        Engine.e.charEquippedWeaponRight[4] = null;
    ...
    public void RemoveChestArmor()
    {
        ...
        // Equip Armor
        chestArmor = null;
        Engine.e.charEquippedChestArmor[4] = null;
    ...
    public void RemoveLegArmor()
    {
        ...
        // Equip Armor
        legArmor = null;
        Engine.e.charEquippedLegArmor[4] = null;
    ...
    public void RemoveAccessory1()
    {
        ...
        accessory1 = null;
        Engine.e.charEquippedAccessory1[4] = null;
    ...
    public void RemoveAccessory2()
    {
        ...
        accessory2 = null;
        Engine.e.charEquippedAccessory2[4] = null;

        Engine.e.equipMenuReference.DisplaySolaceStats();

    }

    public void EquipSolaceWeaponRight(Weapon _weapon)
    {
        ...
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().DisplaySolaceStats();
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().weaponLists[0].SetActive(false);
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().SetSolaceScreen();
    ...
    public void EquipSolaceWeaponRightOnLoad(Weapon _weapon)
    {
    ...
    public void EquipSolaceChestArmor(ChestArmor _armor)
    {
        // Resetting Stats Back to Base Values
        physicalDefense -= chestArmor.GetComponent<ChestArmor>().physicalArmor;
        fireDefense -= chestArmor.GetComponent<ChestArmor>().fireDefense;
        ...
        // Equip Armor
        chestArmor = _armor;
        Engine.e.charEquippedChestArmor[4] = _armor;
    ...
    public void EquipSolaceChestArmorOnLoad(ChestArmor _armor)
    {
        chestArmor = _armor;
        Engine.e.charEquippedChestArmor[4] = _armor;
        //     Engine.e.equipMenuReference.GetComponent<EquipDisplay>().riggsEquippedChestArmor.GetComponent<InventorySlot>().item = _armor;
    ...
    public void EquipSolaceLegArmor(LegArmor _armor)
    {
        // Resetting Stats Back to Base Values
    ...
    public void EquipSolaceLegArmorOnLoad(LegArmor _armor)
    {
        legArmor = _armor;
        Engine.e.charEquippedLegArmor[4] = _armor;
    }
    public void EquipSolaceAccessory1(Accessory _accessory)
    {
        if (accessory1 != null)
        {
            // Resetting Stats Back to Base Values
        ...
        Engine.e.charEquippedAccessory1[4] = _accessory;
    ...
    public void EquipSolaceAccessory1OnLoad(Accessory _accessory)
    {
        if (_accessory != null)
        {
            accessory1 = _accessory;
    ...
    public void EquipSolaceAccessory2(Accessory _accessory)
    {
        // Resetting Stats Back to Base Values
        if (accessory2 != null)
        {
        ...
        Engine.e.charEquippedAccessory2[4] = _accessory;
    ...
    public void EquipSolaceAccessory2OnLoad(Accessory _accessory)
    {
        if (_accessory != null)
        {
            accessory2 = _accessory;
