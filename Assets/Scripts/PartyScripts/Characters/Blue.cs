...
public class Blue : Character
{
    public void RemoveWeaponRight()
    {
        ...
        weaponRight = null;
        Engine.e.charEquippedWeaponRight[5] = null;

        Engine.e.equipMenuReference.DisplayBlueStats();
    }
    ...
    public void RemoveChestArmor()
    {
        ...
        // Equip Armor
        chestArmor = null;
        Engine.e.charEquippedChestArmor[5] = null;
    ...
    public void RemoveLegArmor()
    {
        ...
        // Equip Armor
        legArmor = null;
        Engine.e.charEquippedLegArmor[5] = null;
    ...
    public void RemoveAccessory1()
    {
        ...
        accessory1 = null;
        Engine.e.charEquippedAccessory1[5] = null;
    ...
    public void RemoveAccessory2()
    {
        ...
        accessory2 = null;
        Engine.e.charEquippedAccessory2[5] = null;

        Engine.e.equipMenuReference.DisplayBlueStats();

    }

    public void EquipBlueWeaponRight(Weapon _weapon)
    {
        ...
        // Equip Weapon
        weaponRight = _weapon;
        Engine.e.charEquippedWeaponRight[5] = _weapon;
        ...
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().DisplayBlueStats();
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().weaponLists[0].SetActive(false);
        Engine.e.equipMenuReference.GetComponent<EquipDisplay>().SetBlueScreen();
    ...
    public void EquipBlueWeaponRightOnLoad(Weapon _weapon)
    {
    ...
    public void EquipBlueChestArmor(ChestArmor _armor)
    {
        // Resetting Stats Back to Base Values
        physicalDefense -= chestArmor.GetComponent<ChestArmor>().physicalArmor;
        fireDefense -= chestArmor.GetComponent<ChestArmor>().fireDefense;
        ...
        // Equip Armor
        chestArmor = _armor;
        Engine.e.charEquippedChestArmor[5] = _armor;
    ...
    public void EquipBlueChestArmorOnLoad(ChestArmor _armor)
    {
        chestArmor = _armor;
        Engine.e.charEquippedChestArmor[5] = _armor;
        //     Engine.e.equipMenuReference.GetComponent<EquipDisplay>().riggsEquippedChestArmor.GetComponent<InventorySlot>().item = _armor;
    ...
    public void EquipBlueLegArmor(LegArmor _armor)
    {
        // Resetting Stats Back to Base Values
        ...
        // Equip Armor
        legArmor = _armor;
        Engine.e.charEquippedLegArmor[5] = _armor;
    ...
    public void EquipBlueLegArmorOnLoad(LegArmor _armor)
    {
        legArmor = _armor;
        Engine.e.charEquippedLegArmor[5] = _armor;
    }
    public void EquipBlueAccessory1(Accessory _accessory)
    {
        if (accessory1 != null)
        {
            // Resetting Stats Back to Base Values
        ...
        Engine.e.charEquippedAccessory1[5] = _accessory;
    ...
    public void EquipBlueAccessory1OnLoad(Accessory _accessory)
    {
        if (_accessory != null)
        {
            accessory1 = _accessory;
    ...
    public void EquipBlueAccessory2(Accessory _accessory)
    {
        // Resetting Stats Back to Base Values
        if (accessory2 != null)
        {
        ...
        Engine.e.charEquippedAccessory2[5] = _accessory;
    ...
    public void EquipBlueAccessory2OnLoad(Accessory _accessory)
    {
        if (_accessory != null)
        {
            accessory2 = _accessory;
